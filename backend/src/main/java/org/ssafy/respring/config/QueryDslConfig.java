...
import org.ssafy.respring.domain.common.counter.repository.CounterRepository;
...
@EnableJpaRepositories(
  ...
  excludeFilters = {
	...
	@ComponentScan.Filter(type = FilterType.ASSIGNABLE_TYPE, value = CounterRepository.class)
  }
