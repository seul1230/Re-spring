    ...
    <div className="bg-white rounded-2xl overflow-hidden w-full shadow-sm hover:shadow-md transition-shadow duration-300" onClick={handleClick}>
      <div className="flex p-2 xs:p-3 sm:p-4">
        ...
        <div className="flex-1 flex flex-col min-w-0">
          ...
          <div className="flex items-center justify-between gap-1 xs:gap-2 sm:gap-4 mt-auto">
            <div className="hidden xs:flex gap-1 sm:gap-2 min-w-0 flex-shrink overflow-hidden">
