...
export default function ChallengePage({ params }: { params: { id: string } }) {
  ...
  return (
    <main className="min-h-screen bg-background pt-14 pb-16 md:pt-6 md:pb-6 flex flex-col">
                ...
                <div className="lg:hidden">
                  <Tabs defaultValue="detail" className="w-full">
                    <TabsList className="w-full rounded-none h-12 border-b">
                      <TabsTrigger
                        value="detail"
                        className="flex-1 data-[state=active]:border-b-2 data-[state=active]:border-[#8BC34A]"
                      >
                        도전 상세
                      </TabsTrigger>
                      <TabsTrigger
