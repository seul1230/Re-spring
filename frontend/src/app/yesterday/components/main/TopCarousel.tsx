...
import { getTopThreeWeeklyBooks, getAllBooksByUserNickname, type Book } from "@/lib/api"
  ...
  return (
    <Tabs defaultValue="weekly" onValueChange={(value) => setActiveTab(value)} className="w-full">
      ...
      <TabsContent value="weekly">
        {loading ? <BookSkeletonCarousel /> : <BookCarousel books={weeklyBooks} />}
      </TabsContent>
      <TabsContent value="latest">
        {loading ? <BookSkeletonCarousel /> : <BookCarousel books={subscriberBooks} />}
      </TabsContent>
    </Tabs>
  )
}
