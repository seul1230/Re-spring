  ...
  return (
    <section className="relative min-h-[80vh] text-white">
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-black/50 via-black/70 to-black">
        <Image src={book.coverImage || getRandomImage()} alt="cover image" layout="fill" objectFit="cover" className="opacity-30 blur-md" />
      </div>
      ...
      <div className="relative z-10 flex flex-col items-center px-4 pt-10">
          ...
          <CardContent className="p-0">
            <AspectRatio ratio={156 / 234}>
              <Image
                ...
                alt={book.title}
                fill
                className={cn("rounded-lg object-cover transition-all duration-500 ease-in-out", isImageExpanded ? "object-contain" : "object-cover")}
              />
            </AspectRatio>
          </CardContent>
        </Card>
        ...
        <div className="flex items-center gap-4 mb-4">
          ...
          <div className="flex items-center gap-1">
            <Button variant="ghost" size="sm" className={cn("p-0  ", isHeartAnimating && !isLiked && "animate-bounce")} onClick={handleClickLike}>
